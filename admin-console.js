...
function addProject(e) {
    ...
    loadProjects();
    mostrarFeedback('✅ Proyecto agregado');
}
...
function deleteProject(id) {
    if (confirm('¿Eliminar este proyecto?')) {
        ...
        loadProjects();
        mostrarFeedback('🗑️ Proyecto eliminado');
    }
}
...
function addExperience(e) {
    ...
    loadExperiences();
    mostrarFeedback('✅ Experiencia agregada');
}
...
function deleteExperience(id) {
    if (confirm('¿Eliminar esta experiencia?')) {
        ...
        loadExperiences();
        mostrarFeedback('🗑️ Experiencia eliminada');
    }
}
...
function addSkill(e) {
    ...
    loadSkills();
    mostrarFeedback('✅ Habilidad agregada');
}
...
function deleteSkill(id) {
    if (confirm('¿Eliminar esta habilidad?')) {
        ...
        loadSkills();
        mostrarFeedback('🗑️ Habilidad eliminada');
    }
}
...
function addCertificate(e) {
    ...
    loadCertificates();
    mostrarFeedback('✅ Certificado agregado');
}
...
function deleteCertificate(id) {
    if (confirm('¿Eliminar este certificado?')) {
        ...
        loadCertificates();
        mostrarFeedback('🗑️ Certificado eliminado');
    }
}
